...
{/* 
          ...
          <div className="boxText">
            <h1>As parábolas resumidas e ilustradas  + <br /> Templates plano de estudo bíblico + <br />Panorama do Antigo Testamento + <br />Disciplinas biblicas</h1>

            <span>De R$122,49</span>
            <div>2x de R$40,00</div>
